...
To visualize the TTC_camera from a wide variety of combination of detectors and descriptors, the TTC data from lidar and camera are saved into csv file `data_ttc.csv`. For individual detector, the ttc_camera data with each descriptors are shown along the frame index.
...
<img src="images/SHITOMASI_data.png" width="500" height="300" />

**_HARRIS_detector_**：
<img src="images/HARRIS_data.png" width="500" height="300" />

**_ORB_detector_**：
<img src="images/ORB_data.png" width="500" height="300" />

**_SIFT_detector_**：
<img src="images/SFIT_data.png" width="500" height="300" />

**_FAST_detector_**：
<img src="images/FAST_data.png" width="500" height="300" />

**_BRISK_detector_**：
<img src="images/BRISK_data.png" width="500" height="300" />

**_AKAZE_detector_**：
<img src="images/AKAZE_data.png" width="500" height="300" />
...
(1) mismatches of the feature; (2) noise matches beyond the object's boundary.
<img src="images/failed.png" width="1000" height="555" />
...
Here are candidates plot from BRIEF descriptor series, also the top 3 picks from previous projects.

<img src="images/data_plot.png" width="1000" height="800" />
...
**Conclusion II**:
(a) camera-based TCC estimation did depend on the combination of detector and descriptor.
(b) camera-based TCC estimation could be affetced by the quality of fetaure matching.
